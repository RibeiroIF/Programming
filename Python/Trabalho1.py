...
while (cont < clients):
    ...
    if (car1total > car2total and car1total > car3total):
        carM = car1
    if (car2total > car1total and car2total > car3total):
        carM = car2
    if (car3total > car2total and car3total > car1total):
        carM = car3
    if (serv1total > serv2total and serv1total > serv3total):
        servM = serv1    
    if (serv2total > serv1total and serv2total > serv3total):
        servM = serv2
    if (serv3total > serv1total and serv3total > serv2total):
        servM = serv3
    if (serv3total > serv1total and serv3total > serv2total):
        servM = serv3
    if (car1total == car2total or car1total == car3total):
        carM = "Empate"
    if (serv3total == serv1total or serv3total == serv2total):
        servM = "Empate"
    ...
    print("Olá",name," seu veículo é do tipo",carN,", e o serviço escolhido foi o de",servN)
    cont=cont+1
