...
public class Trabalho1 {
	...
	public static void main(String[] args) {
		...
		String carM = "", servM ="", carN = "", servN = "", name = ""; 
		...
		while (cont<clients) {
			...
			if (car2total > car1total && car2total > car3total){
				carM = car2;
			}
			if (car3total > car2total && car3total > car1total){
				carM = car3;
			}
			if (serv1total > serv2total && serv1total > serv3total) {
				servM = serv1;
			}
			if (serv2total > serv1total && serv2total > serv3total) {
				servM = serv2;
			}
			if (serv3total > serv2total && serv3total > serv1total) {
				servM = serv3;
			}
		...
		System.out.print("Olá "+name+", seu veículo é do tipo "+carN+", o serviço contratado foi o "+servN+" e seu custo é de R$"+cost+"\n\n");
		cont++;
		}
		System.out.print("------------------------------------------------------------------------------------------------\n");
		...
		System.out.print("------------------------------------------------------------------------------------------------");
		System.out.print("\nOperação concluída. Volte sempre!!");
	}
